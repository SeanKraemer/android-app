...
/**
 * Espresso tests for DetailsActivity, following the project's testing pattern.
 * These tests use the real WeatherApiService and depend on a network connection.
 */
...
public class DetailsActivityTest {
    ...
    public void testInvalidCity_DisplaysErrorMessage() throws InterruptedException {
        ...
        // Check that the UI displays the expected error messages
